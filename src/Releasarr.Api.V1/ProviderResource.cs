        ...
        where TProviderDefinition : ProviderDefinition, new()
    {
        public virtual TProviderResource ToResource(TProviderDefinition definition)
        {
            return new TProviderResource
            {
                ...
                //releasarr/supported#{0} is a disambiguation page. the # should be a header on the page with appropriate details/link
                // note: indexers get a different link
                InfoLink = string.Format("https://wiki.servarr.com/releasarr/supported#{0}",
