...
namespace NzbDrone.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "releasarr.db";
        private const string DB_RESTORE = "releasarr.restore";
        private const string LOG_DB = "logs.db";
        private const string NLOG_CONFIG_FILE = "nlog.config";
        private const string UPDATE_CLIENT_EXE_NAME = "Releasarr.Update";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "releasarr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Releasarr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "releasarr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "releasarr_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Releasarr.Update" + Path.DirectorySeparatorChar;
