...
namespace NzbDrone.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        // Webhooks - Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/releasarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
        ...
        // Internal
        [TestCase(@"[Info] MigrationController: *** Migrating Database=releasarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase("/readarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=releasarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        [TestCase(@"https://torrentapi.org/pubapi_v2.php?get_token=get_token&app_id=Releasarr")]
